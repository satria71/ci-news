                  ...
                  <div class="card-body p-0">
                    <div class="table-responsive table-invoice">
                      <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                          <?php if (!empty($stokterbanyak)) : ?>
                            <?php foreach ($stokterbanyak as $row) : ?>
                              <tr>
                                <td><?= esc($row->kode_barang) ?></td>
                                <td class="font-weight-600"><?= esc($row->nama_barang) ?></td>
                                ...
                                <td style="text-align:center;">
                                  ...
                                  <?php elseif ($row->status == 'Over 1.5*pkm') : ?>
                                    <div class="badge badge-warning"><?= esc($row->status) ?></div>
                                  <?php elseif ($row->status == 'Aman') : ?>
                                    <div class="badge badge-success"><?= esc($row->status) ?></div>
                                  <?php else : ?>
                                    <div class="badge badge-info"><?= esc($row->status) ?></div>
                                  <?php endif; ?>
                                </td>
                              </tr>
                            <?php endforeach; ?>
